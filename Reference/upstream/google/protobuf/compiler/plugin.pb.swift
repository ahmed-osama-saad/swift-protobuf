...
struct Google_Protobuf_Compiler_CodeGeneratorRequest {
  ...
  /// fully qualified.
  var protoFile: [SwiftProtobufAlias.Google_Protobuf_FileDescriptorProto] = []

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  var sourceFileDescriptors: [SwiftProtobufAlias.Google_Protobuf_FileDescriptorProto] = []
...
struct Google_Protobuf_Compiler_CodeGeneratorResponse {
  ...
  enum Feature: SwiftProtobufAlias.Enum {
  ...
  struct File {
    ...
    var generatedCodeInfo: SwiftProtobufAlias.Google_Protobuf_GeneratedCodeInfo {
