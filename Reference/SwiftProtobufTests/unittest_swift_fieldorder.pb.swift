...
struct Swift_Protobuf_TestFieldOrderings: SwiftProtobufAlias.ExtensibleMessage {
...
struct Swift_Protobuf_OneofTraversalGeneration: SwiftProtobufAlias.ExtensibleMessage {
  // SwiftProtobufAlias.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobufAlias library for
  // methods supported on all messages.
...
let Swift_Protobuf_UnittestSwiftFieldorder_Extensions: SwiftProtobufAlias.SimpleExtensionMap = [
...
let Swift_Protobuf_Extensions_my_extension_string = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufString>, Swift_Protobuf_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "swift.protobuf.my_extension_string"
)

let Swift_Protobuf_Extensions_my_extension_int = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufInt32>, Swift_Protobuf_TestFieldOrderings>(
...
extension Swift_Protobuf_TestFieldOrderings: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension Swift_Protobuf_TestFieldOrderings.NestedMessage: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension Swift_Protobuf_OneofTraversalGeneration: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
