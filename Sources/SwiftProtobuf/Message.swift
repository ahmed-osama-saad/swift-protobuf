...
///
/// In general, use `SwiftProtobufAlias.Message` instead when you need a variable or
/// argument that can hold any type of message. Occasionally, you can use
/// `SwiftProtobufAlias.Message & Equatable` or `SwiftProtobufAlias.Message & Hashable` as
