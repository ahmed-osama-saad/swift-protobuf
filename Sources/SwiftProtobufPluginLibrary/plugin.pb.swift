...
public struct Google_Protobuf_Compiler_CodeGeneratorRequest {
  ...
  /// fully qualified.
  public var protoFile: [SwiftProtobufAlias.Google_Protobuf_FileDescriptorProto] = []

  /// File descriptors with all options, including source-retention options.
  /// These descriptors are only provided for the files listed in
  /// files_to_generate.
  public var sourceFileDescriptors: [SwiftProtobufAlias.Google_Protobuf_FileDescriptorProto] = []
...
public struct Google_Protobuf_Compiler_CodeGeneratorResponse {
  ...
  public enum Feature: SwiftProtobufAlias.Enum {
  ...
  public struct File {
    ...
    public var generatedCodeInfo: SwiftProtobufAlias.Google_Protobuf_GeneratedCodeInfo {
      get {return _generatedCodeInfo ?? SwiftProtobufAlias.Google_Protobuf_GeneratedCodeInfo()}
    ...
    fileprivate var _generatedCodeInfo: SwiftProtobufAlias.Google_Protobuf_GeneratedCodeInfo? = nil
  }
...
extension Google_Protobuf_Compiler_Version: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorRequest: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
  ...
  public var isInitialized: Bool {
    if !SwiftProtobufAlias.Internal.areAllInitialized(self.protoFile) {return false}
    if !SwiftProtobufAlias.Internal.areAllInitialized(self.sourceFileDescriptors) {return false}
    return true
  }
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.Feature: SwiftProtobufAlias._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobufAlias._NameMap = [
...
extension Google_Protobuf_Compiler_CodeGeneratorResponse.File: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
