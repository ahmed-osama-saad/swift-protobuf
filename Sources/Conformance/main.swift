...
func buildResponse(serializedData: Data) -> Conformance_ConformanceResponse {
    ...
    let msgType: SwiftProtobufAlias.Message.Type
    let extensions: SwiftProtobufAlias.ExtensionMap
    ...
    case ProtobufTestMessages_Proto3_TestAllTypesProto3.protoMessageName:
        ...
        extensions = SwiftProtobufAlias.SimpleExtensionMap()
    ...
    let testMessage: SwiftProtobufAlias.Message
