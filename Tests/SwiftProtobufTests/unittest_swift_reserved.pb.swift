...
struct ProtobufUnittest_SwiftReservedTest {
  ...
  enum ProtocolEnum: SwiftProtobufAlias.Enum {
    typealias RawValue = Int
    case a // = 1
  ...
  struct classMessage: SwiftProtobufAlias.ExtensibleMessage {
    // SwiftProtobufAlias.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobufAlias library for
    // methods supported on all messages.
  ...
  struct TypeMessage: SwiftProtobufAlias.ExtensibleMessage {
    // SwiftProtobufAlias.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobufAlias library for
    // methods supported on all messages.
...
let ProtobufUnittest_UnittestSwiftReserved_Extensions: SwiftProtobufAlias.SimpleExtensionMap = [
...
/// Won't get _p added because it is fully qualified.
let ProtobufUnittest_Extensions_debug_description = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
...
/// These are scoped to the file, so the package prefix (or a Swift prefix)
/// will get added to them to they aren't going to get renamed.
let ProtobufUnittest_Extensions_as = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1012,
  fieldName: "protobuf_unittest.as"
)

let ProtobufUnittest_Extensions_var = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1013,
  fieldName: "protobuf_unittest.var"
)

let ProtobufUnittest_Extensions_try = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1014,
  fieldName: "protobuf_unittest.try"
)

let ProtobufUnittest_Extensions_do = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
  _protobuf_fieldNumber: 1015,
  fieldName: "protobuf_unittest.do"
)

let ProtobufUnittest_Extensions_nil = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
...
extension ProtobufUnittest_SwiftReservedTestExt {
  enum Extensions {
    ...
    /// the raw form is used ("hash_value", not the Swift one "hashValue"),
    /// so there is no conflict, and no renaming happens.
    static let hash_value = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
    ...
    /// Reserved words, since these end up in the "struct Extensions", they
    /// can't just be get their names, and sanitation kicks.
    static let `as` = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1022,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.as"
    )

    static let `var` = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1023,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.var"
    )

    static let `try` = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1024,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.try"
    )

    static let `do` = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
      _protobuf_fieldNumber: 1025,
      fieldName: "protobuf_unittest.SwiftReservedTestExt.do"
    )

    static let `nil` = SwiftProtobufAlias.MessageExtension<SwiftProtobufAlias.OptionalExtensionField<SwiftProtobufAlias.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.classMessage>(
...
extension ProtobufUnittest_SwiftReservedTest: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTest.Enum: SwiftProtobufAlias._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobufAlias._NameMap = [
    1: .same(proto: "DOUBLE"),
    2: .same(proto: "JSON"),
    3: .same(proto: "CLASS"),
...
extension ProtobufUnittest_SwiftReservedTest.ProtocolEnum: SwiftProtobufAlias._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobufAlias._NameMap = [
    1: .same(proto: "a"),
  ]
}

extension ProtobufUnittest_SwiftReservedTest.classMessage: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTest.TypeMessage: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTest.isEqual: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
...
extension ProtobufUnittest_SwiftReservedTestExt: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
