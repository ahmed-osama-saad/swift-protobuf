...
struct ProtobufUnittest_SwiftJSONTest {
  ...
  var repeatedNullValue: [SwiftProtobufAlias.Google_Protobuf_NullValue] = []
...
extension ProtobufUnittest_SwiftJSONTest: SwiftProtobufAlias.Message, SwiftProtobufAlias._MessageImplementationBase, SwiftProtobufAlias._ProtoNameProviding {
