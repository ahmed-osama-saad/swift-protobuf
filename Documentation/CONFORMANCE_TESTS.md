...
SwiftProtobufAlias currently passes Google's entire conformance test suite.
We have integrated the conformance test with the SwiftProtobufAlias test
...
We strongly recommend anyone making changes to SwiftProtobufAlias run
...
$ make test
```
This will build and run the SwiftProtobufAlias test suite,
...
The `Makefile` at the root of the SwiftProtobufAlias project has the
